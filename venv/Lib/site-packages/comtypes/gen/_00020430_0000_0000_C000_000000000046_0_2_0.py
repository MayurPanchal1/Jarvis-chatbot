...
__all__ = [ 'FONTSIZE', 'Checked', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'OLE_COLOR',
           'FONTUNDERSCORE', 'OLE_XPOS_CONTAINER', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'FONTITALIC', 'OLE_XPOS_HIMETRIC',
           'Font', 'Gray', 'OLE_HANDLE', 'LoadPictureConstants',
           'FontEvents', 'Monochrome', 'IFontEventsDisp', 'IFont',
           'IPicture', 'OLE_YSIZE_PIXELS', 'OLE_XPOS_PIXELS',
           'OLE_XSIZE_HIMETRIC', 'IFontDisp', 'FONTNAME', 'Unchecked',
           'OLE_ENABLEDEFAULTBOOL', 'Picture', 'Default',
           'OLE_YSIZE_HIMETRIC', 'VgaColor', 'OLE_YPOS_HIMETRIC',
           'StdFont', 'OLE_TRISTATE', 'OLE_OPTEXCLUSIVE',
           'OLE_YPOS_PIXELS', 'StdPicture', 'FONTSTRIKETHROUGH',
           'IPictureDisp', 'Color', 'OLE_CANCELBOOL']
from comtypes import _check_version; _check_version('1.1.10', 1651900738.765207)
